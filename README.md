...
|<p>2 Conv layers with regularizaion</p><p>Experiment with full data </p>|<p>Architecture: [32 Conv(3,3,3), maxpool(2,2,2), 64 conv(2,2,2), maxpooling(2,2,2), flatten, dense(256), dense(256), softmax, Activation=relu</p><p></p><p>Batch size = 15</p><p>Epochs = 25</p><p>Image dimensions = 120,120</p><p>Samples per image = 15</p>|81%||23s| Overfitting reduce, but the accuracy is too low |
