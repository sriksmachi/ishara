...
| :- | :- | :- | :- | :- | :- |
|<p>2 Conv layers</p><p>Ablation Experiment </p>|<p>Architecture: [32 Conv(3,3,3), maxpool(2,2,2), 64 conv(2,2,2), maxpooling(2,2,2), flatten, dense(512), dense(512), softmax</p><p>Activation=relu, optimizer=sgd</p>|NA|55,400,581|NA|The model looks correct.|
|<p>2 Conv layers</p><p>Overfitting Intentionally</p>|<p>Architecture: [32 Conv(3,3,3), maxpool(2,2,2), 64 conv(2,2,2), maxpooling(2,2,2), flatten, dense(512), dense(512), softmax</p><p>Activation=relu, optimizer=sgd</p>|NA||NA|The training accuracy increased steadily, and loss decreased. There was overfitting observed.  |
|<p>2 Conv layers</p><p>Experiment with full data </p>|<p>Architecture: [32 Conv(3,3,3), maxpool(2,2,2), 64 conv(2,2,2), maxpooling(2,2,2), flatten, dense(512), dense(512), softmax, Activation=relu</p><p></p><p>Batch size = 15</p><p>Epochs = 25</p><p>Image dimensions = 120,120</p><p>Samples per image = 15</p>|77%||23s|The training accuracy = 100%, overfitting observed. |
|<p>2 Conv layers with regularizaion</p><p>Experiment with full data </p>|<p>Architecture: [32 Conv(3,3,3), batchnormalization, maxpool(2,2,2), 64 conv(2,2,2), batchnormalization, maxpooling(2,2,2), flatten, dense(512) with l2 regularization, dropout(0.5), dense(512), softmax, Activation=relu</p><p></p><p>Batch size = 15</p><p>Epochs = 25</p><p>Image dimensions = 120,120</p><p>Samples per image = 15</p>|89%||23s| Overfitting reduced to some extent, training accuracy was 99. |
